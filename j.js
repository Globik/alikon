...
-disable-plugin-sip --disable-plugin-sipre --disable-plugin-nosip 
...
./configure --enable-boringssl  --enable-dtls-settimeout -disable-plugin-sip --disable-plugin-sipre --disable-plugin-nosip JANUS_CFLAGS=/usr/local/include JANUS_LIBS="/usr/local/lib /opt/boringssl/lib"

make -L/opt/boringssl/lib -lcrypto -lssl

JANUS_CFLAGS
              C compiler flags for JANUS, overriding pkg-config
  JANUS_LIBS  linker flags for JANUS, overriding pkg-config
